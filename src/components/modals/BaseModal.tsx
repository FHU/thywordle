    ...
    <Transition.Root show={isOpen} as={Fragment}>
      ...
      >
        <div className="flex min-h-full items-center justify-center px-4 py-10 text-center sm:p-0">
          ...
          >
            <div className="inline-block transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left align-bottom shadow-xl transition-all dark:bg-gray-800 sm:my-8 sm:w-full sm:max-w-md sm:p-6 sm:align-middle">
              <button
                onClick={() => handleClose()}
                tabIndex={0}
                aria-label="close"
